...
<template>
   <div class="py-4 first:pt-0 last:pb-0 grid gap-4">
      <div class="flex items-center gap-4">
         ...
         <div class="text-sm">
            <p class="tracking-wide">
               ...
               <u-badge
                  v-if="props.comment.user?.id === user?.id"
                  variant="subtle"
                  color="emerald"
                  size="xs"
                  class="ms-1"
               ...
               <u-badge
                  v-if="props.comment.user?.userable_type === 'supervisor'"
                  variant="subtle"
                  color="cyan"
                  size="xs"
                  class="ms-1"
               ...
               <u-badge
                  v-if="props.comment.user?.userable_type === 'officer'"
                  variant="subtle"
                  color="gray"
                  size="xs"
                  class="ms-1"
               ...
               <u-badge
                  v-if="!props.comment.user?.userable_type"
                  variant="subtle"
                  color="amber"
                  size="xs"
                  class="ms-1"
      ...
      <div class="flex divide-x">
         <template v-if="(props.comment.replies ?? []).length > 0">
            <u-button
            ...
            >
               Lihat balasan ({{ props.comment.replies?.length }})
            </u-button>
